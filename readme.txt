...
Stable tag: trunk
License: MIT
License URI: https://github.com/stayallive/wp-sentry/blob/v7.4.0/LICENSE.md
...
_For more information and documentation have a look at the [full documentation](https://github.com/stayallive/wp-sentry/tree/v7.4.0#readme)._
...
To start using the plugin first setup the [DSN](https://github.com/stayallive/wp-sentry/tree/v7.4.0#dsn) for either the PHP side or the Browser side or both.
...
_You can find more information and the full documentation: [here](https://github.com/stayallive/wp-sentry/tree/v7.4.0#configuration). The following are the basics._
...
_You can find more information and the full documentation: [here](https://github.com/stayallive/wp-sentry/tree/v7.4.0#configuration). The above are the basics._
