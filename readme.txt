...
_For more information and documentation have a look at the [README.md](https://github.com/stayallive/wp-sentry/blob/v4.6.0/README.md) file._
...
`define( 'WP_SENTRY_VERSION', 'v4.6.0' );`
