...
_For more information and documentation have a look at the [README.md](https://github.com/stayallive/wp-sentry/blob/v6.7.0/README.md) file._
...
`define( 'WP_SENTRY_VERSION', 'v6.7.0' );`
