...
_For more information and documentation have a look at the [README.md](https://github.com/stayallive/wp-sentry/blob/v3.9.0/README.md) file._
...
`define( 'WP_SENTRY_VERSION', 'v3.9.0' );`
